...
//   return (
//     <footer
//       className="relative w-full overflow-hidden bg-gradient-to-br from-slate-50 via-gray-100 to-slate-100 p-8"
...
//             className="inline-flex h-10 w-10 items-center justify-center rounded-xl border border-violet-200/60 bg-white/80 text-slate-600 backdrop-blur-sm transition-all duration-200 hover:border-violet-300 hover:bg-violet-50 hover:text-violet-700 hover:shadow-md"
//           >
